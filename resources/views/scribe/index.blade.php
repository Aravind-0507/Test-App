                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-login">POST api/login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-google-login">
                                <a href="#endpoints-POSTapi-google-login">POST api/google-login</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-register">POST api/register</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-payments-create-order">
                                <a href="#endpoints-POSTapi-payments-create-order">POST api/payments/create-order</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-google-login">POST api/google-login</h2>
...
<span id="example-requests-POSTapi-google-login">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-google-login">
</span>
<span id="execution-results-POSTapi-google-login" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-google-login"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-google-login"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-google-login" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-google-login">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-google-login" data-method="POST"
      data-path="api/google-login"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-google-login', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-google-login"
                    onclick="tryItOut('POSTapi-google-login');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-google-login"
                    onclick="cancelTryOut('POSTapi-google-login');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-google-login"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-google-login"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-google-login"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="POSTapi-google-login"
               value="architecto"
               data-component="body">
    <br>
...
<code class="language-json" style="max-height: 300px;">[
    {
        ...
        &quot;created_at&quot;: &quot;2025-09-22T11:12:17.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-22T11:12:17.000000Z&quot;
    },
    {
        &quot;id&quot;: 3,
        &quot;name&quot;: &quot;test&quot;,
        ...
        &quot;phone&quot;: &quot;+916382352721&quot;,
        &quot;email_verified_at&quot;: null,
        &quot;created_at&quot;: &quot;2025-09-22T11:14:51.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-22T11:14:51.000000Z&quot;
    },
    {
        &quot;id&quot;: 6,
        &quot;name&quot;: &quot;architectoe&quot;,
        &quot;email&quot;: &quot;zbailey@example1.net&quot;,
        &quot;phone&quot;: &quot;34455324&quot;,
        &quot;email_verified_at&quot;: null,
        &quot;created_at&quot;: &quot;2025-09-24T05:59:55.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-24T05:59:55.000000Z&quot;
    },
    {
        &quot;id&quot;: 7,
        &quot;name&quot;: &quot;architecto&quot;,
        ...
        &quot;phone&quot;: &quot;architecto&quot;,
        &quot;email_verified_at&quot;: null,
        &quot;created_at&quot;: &quot;2025-09-24T06:52:40.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-09-24T06:52:40.000000Z&quot;
    }
]</code>
 </pre>
    </span>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-payments-create-order">POST api/payments/create-order</h2>
...
<span id="example-requests-POSTapi-payments-create-order">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-payments-create-order">
</span>
<span id="execution-results-POSTapi-payments-create-order" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-payments-create-order"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-payments-create-order"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-payments-create-order" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-payments-create-order">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-payments-create-order" data-method="POST"
      data-path="api/payments/create-order"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-payments-create-order', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-payments-create-order"
                    onclick="tryItOut('POSTapi-payments-create-order');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-payments-create-order"
                    onclick="cancelTryOut('POSTapi-payments-create-order');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-payments-create-order"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/payments/create-order</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-payments-create-order"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-payments-create-order"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="POSTapi-payments-create-order"
               value="16"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="razorpay_order_id"                data-endpoint="POSTapi-payments-verify"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="razorpay_payment_id"                data-endpoint="POSTapi-payments-verify"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="razorpay_signature"                data-endpoint="POSTapi-payments-verify"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>payment_db_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="payment_db_id"                data-endpoint="POSTapi-payments-verify"
               value="16"
               data-component="body">
    <br>
